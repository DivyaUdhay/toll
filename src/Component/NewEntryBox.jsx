...
function NewEntryBox({ newEntry, setNewEntry }) {
  ...
  //     localTolls
  //       .filter((entry) => {
  //         if (formik.values.tollname == entry.tollname) {
  //           return entry;
  //         }
  //       })
  //       .filter((entry) => {
  //         if (formik.values.vechileType == entry.vechileType) {
  //           return entry;
  //         }
  //       })
  //       .filter((entry) => {
  ...
  //           entry.vechileNo
  //             .toLowerCase()
  //             .includes(formik.values.vechileNo.toLowerCase())
  //         ) {
  //           formik.values.tariff = entry.double1;
  //         }
  //       });
  //   }
  {
